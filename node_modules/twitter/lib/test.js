...
//var id = {'user_id': 4503597479886593};

id = 4503597479886593;

//id = {'screen_name': 'desmondmorris'}
...
twit.getFollowersIds(id, function(data){
  console.log(data);
});

keyword = 'desmond morris';

twit.search(keyword, function(result) {
  console.log(result);
});
